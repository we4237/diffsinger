...
def set_hparams(config='', exp_name='', hparams_str='', print_hparams=True, reset=True, global_hparams=True):
    if config == '':
        parser = argparse.ArgumentParser(description='neural music')    
        parser.add_argument('--config', type=str, default='usr/configs/midi/e2e/opencpop/ds1000.yaml',
                            help='location of the data corpus')
        parser.add_argument('--exp_name', type=str, default='0831_compare', help='exp_name')
